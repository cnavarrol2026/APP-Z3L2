...
- La base comienza vacía.
- Solo aparecen activos en consulta.
- Borradores e inactivos no aparecen en consulta.
- Todos los usuarios autenticados con Google administran.
- No hay roles.
...
- Un borrador solo puede editarlo un usuario a la vez.
